...
$string['settings_statistics_head'] = 'Настройки статистики';
...
$string['showtaskcountcomlpited'] = 'Отображать количество выполненных заданий';
$string['showtaskcountcomlpiteddescription'] = 'Включить/выключить отображение количества выполненных заданий';
